    ...
    <div>
      ...
      <FormControl onSubmit={handleSubmit}>
        ...
        <FormGroup>
          ...
          <FormControlLabel
            control={<Checkbox onChange={handleInput} name={"vegan"} />}
            label={"Vegan"}
          />
          <FormControlLabel
            control={<Checkbox onChange={handleInput} name={"vegetarian"} />}
            label={"Vegetarian"}
          />
          <FormControlLabel
            control={<Checkbox onChange={handleInput} name={"halal"} />}
            label={"Halal"}
          />
          <FormControlLabel
            control={<Checkbox onChange={handleInput} name={"glutenFree"} />}
            label={"Gluten free"}
          />
        </FormGroup>
